...
@section('content')
    <div class="max-w-xl mx-auto mt-8 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        ...
        <h1 class="text-2xl font-bold mb-6 text-gray-800 dark:text-gray-100">Create New Tag</h1>
        <form action="{{ route('tags.store') }}" method="POST">
            ...
            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">Create Tag</button>
        </form>
    </div>
@endsection